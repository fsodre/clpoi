# This is script fetches results from a search for apartments at
# craigslist and filters them to show results that are close to a given
# list of points of interest, which are given in an external file using
...
Usage:
 ...
 Options:
  ...
  --maxResults=<n>           Number of results that must be analyzed to
                             meet your criteria [default: 50]
  ...
  -r --radius=<r>            Maximun distance of the apartments from your
                             points of interest (in kilometers). [default: 0.5]
"""
